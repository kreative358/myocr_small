...
of myocr_small. It can also be called as a standalone script to compile the operator
manually.
'''
import os
import glob
...
def print_error(errors, log_path): 
    ...
    url = "https://github.com/JaidedAI/myocr_small/tree/master/myocr_small/DBNet"
    ...
    print("#"*42)
    print("myocr_small can still be used with CRAFT text detector (default).")
